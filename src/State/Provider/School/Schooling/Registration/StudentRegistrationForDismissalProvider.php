...
final class StudentRegistrationForDismissalProvider implements ProviderInterface
{
    ...
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): object|array|null
    {
        ...
        if($this->getUser()->isIsBranchManager()){
            ...
            foreach ($studentRegistrations as $studentRegistration){
                ...
                if($status == 'registered' || $status == 'resigned') {
                    continue;
                }
        ...
        return array(['newStudentRegistration' => $myStudentRegistrations]);
    }
